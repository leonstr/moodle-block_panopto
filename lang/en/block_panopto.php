...
$string['creatorrolemapping'] = 'Roles set as creators in new Panopto course folders';
...
$string['provisionrole_help'] = 'To alter this setting <a href="{$a->url}">edit roles</a> allowing or disallowing the <em>{$a->capability}</em> capability as required.';
$string['publisher'] = 'Publisher';
$string['publisher_help'] = 'A Publisher can approve content submitted by Creators';
$string['publisherrolemapping'] = 'Roles set as publishers in new Panopto course folders';
...
$string['role_map_header'] = 'Panopto role mappings';
$string['role_map_header_help'] = 'Moodle roles mapped to Panopto roles. Unmapped Moodle roles will be assigned the viewer role in Panopto';
