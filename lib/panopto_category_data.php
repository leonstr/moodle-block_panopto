...
class panopto_category_data {
     ...
     * @param ?stored_progress_bar Optional progress bar to update during build.
     */
    public static function build_category_structure($usehtmloutput, $selectedserver, $selectedkey, ?stored_progress_bar $progress = null) {
        global $CFG, $DB;
